...
public class ModelDownloaderIntegrationTest {
  ...
  public void setup() throws Exception {
    ...
    runShellCommand(
        "cmd device_config put textclassifier textclassifier_service_package_override"
    ...
    tcm.setTextClassifier(null); // Reset TC overrides, such that we will use SystemTC for sure
    textClassifier = tcm.getTextClassifier();
