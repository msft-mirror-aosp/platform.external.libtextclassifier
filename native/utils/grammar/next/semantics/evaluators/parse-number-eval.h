...
#ifndef LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_SEMANTICS_EVALUATORS_PARSE_NUMBER_EVAL_H_
#define LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_SEMANTICS_EVALUATORS_PARSE_NUMBER_EVAL_H_
...
class ParseNumberEvaluator : public SemanticExpressionEvaluator {
 public:
  ...
  StatusOr<const SemanticValue*> Apply(const EvalContext& context,
    ...
    switch (static_cast<reflection::BaseType>(
        parse_number_expression->base_type())) {
      case reflection::BaseType::Byte: {
        TC3_ASSIGN_OR_RETURN(const int32 value, TryParse<int32>(data));
        return arena->AllocAndInit<SemanticValue>(static_cast<int8>(value));
      }
      case reflection::BaseType::UByte: {
        TC3_ASSIGN_OR_RETURN(const int32 value, TryParse<int32>(data));
        return arena->AllocAndInit<SemanticValue>(static_cast<uint8>(value));
      }
      case reflection::BaseType::Short: {
        TC3_ASSIGN_OR_RETURN(const int32 value, TryParse<int32>(data));
        return arena->AllocAndInit<SemanticValue>(static_cast<int16>(value));
      }
      case reflection::BaseType::UShort: {
        TC3_ASSIGN_OR_RETURN(const int32 value, TryParse<int32>(data));
        return arena->AllocAndInit<SemanticValue>(static_cast<uint16>(value));
      }
      case reflection::BaseType::Int: {
        TC3_ASSIGN_OR_RETURN(const int32 value, TryParse<int32>(data));
        return arena->AllocAndInit<SemanticValue>(value);
      }
      case reflection::BaseType::UInt: {
        TC3_ASSIGN_OR_RETURN(const int32 value, TryParse<int32>(data));
        return arena->AllocAndInit<SemanticValue>(static_cast<uint32>(value));
      }
      ...
      case reflection::BaseType::ULong: {
        TC3_ASSIGN_OR_RETURN(const int64 value, TryParse<int64>(data));
        return arena->AllocAndInit<SemanticValue>(static_cast<uint64>(value));
      }
      case reflection::BaseType::Float: {
        TC3_ASSIGN_OR_RETURN(const double value, TryParse<double>(data));
        return arena->AllocAndInit<SemanticValue>(static_cast<float>(value));
      }
...
#endif  // LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_SEMANTICS_EVALUATORS_PARSE_NUMBER_EVAL_H_
