...
#ifndef LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_TESTING_UTILS_H_
#define LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_TESTING_UTILS_H_
...
#include "utils/grammar/next/testing/value_generated.h"
 ...
 protected:
  explicit GrammarTest()
      : unilib_(CreateUniLibForTesting()),
        ...
        semantic_values_schema_(
            GetTestFileContent("utils/grammar/next/testing/value.bfbs")),
    ...
    return arena_.AllocAndInit<SemanticValue>(
        semantic_values_schema_->objects()->Get(
            TypeIdForName(semantic_values_schema_.get(),
                          "libtextclassifier3.grammar.next.TestValue")
                .value()),
  ...
  std::unique_ptr<SemanticExpressionT> CreateConstDateExpression(
    ...
    const_value.type = TypeIdForName(semantic_values_schema_.get(),
                                     "libtextclassifier3.grammar.next.TestDate")
                           .value();
...
#endif  // LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_TESTING_UTILS_H_
