...
#ifndef LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_LEXER_H_
#define LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_LEXER_H_
...
#endif  // LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_LEXER_H_
