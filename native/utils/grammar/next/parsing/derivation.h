...
#ifndef LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_DERIVATION_H_
#define LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_DERIVATION_H_
...
#endif  // LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_DERIVATION_H_
