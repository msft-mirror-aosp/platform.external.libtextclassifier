...
#ifndef LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_PARSE_TREE_H_
#define LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_PARSE_TREE_H_
...
#endif  // LIBTEXTCLASSIFIER_UTILS_GRAMMAR_NEXT_PARSING_PARSE_TREE_H_
